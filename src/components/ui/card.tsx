...
function Card({ className, ...props }: ComponentProps<"div">) {
  return (
    <div
      data-slot="card"
      className={cn(
        "text-card-foreground flex flex-col gap-5 rounded-2xl border border-border bg-card py-5 shadow-sm transition-colors duration-200 dark:border-[rgba(0,119,255,0.26)] dark:bg-[rgba(7,17,31,0.92)] dark:shadow-[0_18px_34px_-28px_rgba(2,6,18,0.78)]",
        className
      )}
      {...props}
    />
