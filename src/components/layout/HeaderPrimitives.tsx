...
export const ENTERPRISE_COMMAND_STRIP_CLASS =
  "border-b border-border bg-white/95 text-[#475569] backdrop-blur-sm shadow-[inset_0_-1px_0_0_rgba(207,232,246,0.16)] dark:border-[rgba(0,119,255,0.26)] dark:bg-[rgba(7,17,31,0.90)] dark:text-[#F8FAFC] dark:shadow-[inset_0_-1px_0_0_rgba(0,199,232,0.10)]"
...
export const ENTERPRISE_CONTROL_CLASS =
  "inline-flex h-7 items-center gap-1.5 px-2.5 sm:px-3 rounded-full border border-border bg-white text-[#475569] font-medium transition-all duration-150 hover:text-[#07111F] hover:border-primary/35 hover:bg-secondary focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring/45 focus-visible:ring-offset-2 focus-visible:ring-offset-background dark:border-[rgba(0,119,255,0.26)] dark:bg-[rgba(11,22,40,0.72)] dark:text-muted-foreground dark:hover:text-[#F8FAFC] dark:hover:bg-[rgba(11,22,40,0.86)]"

export const ENTERPRISE_ICON_CONTROL_CLASS =
  "inline-flex h-7 w-7 items-center justify-center rounded-full border border-border bg-white text-[#475569] font-medium transition-all duration-150 hover:text-[#07111F] hover:border-primary/35 hover:bg-secondary focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring/45 focus-visible:ring-offset-2 focus-visible:ring-offset-background dark:border-[rgba(0,119,255,0.26)] dark:bg-[rgba(11,22,40,0.72)] dark:text-muted-foreground dark:hover:text-[#F8FAFC] dark:hover:bg-[rgba(11,22,40,0.86)]"
...
export const ENTERPRISE_NAV_ITEM_CLASS =
  "relative inline-flex items-center gap-1.25 rounded-sm border whitespace-nowrap px-3 xl:px-3.5 py-1 text-[13px] xl:text-[14px] tracking-[0.01em] font-normal transition-all duration-150"
...
export const ENTERPRISE_NAV_ITEM_INACTIVE_CLASS =
  "text-[#475569] border-transparent hover:text-[#07111F] hover:border-border hover:bg-secondary dark:text-muted-foreground dark:hover:text-[#F8FAFC] dark:hover:border-[rgba(0,119,255,0.26)] dark:hover:bg-[rgba(0,199,232,0.08)]"
