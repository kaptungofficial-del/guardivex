...
export const ENTERPRISE_COMMAND_STRIP_CLASS =
  "border-b border-[var(--gvx-hero-border)] bg-[var(--gvx-hero-surface)] text-[var(--gvx-hero-muted)] backdrop-blur-2xl shadow-none"

export const ENTERPRISE_HEADER_SURFACE_CLASS =
  "border-b border-[var(--gvx-hero-border)] bg-[var(--gvx-hero-surface)] text-[var(--gvx-hero-text)] shadow-[0_12px_34px_-32px_rgba(7,17,31,0.35)] backdrop-blur-2xl"
...
export const ENTERPRISE_NAV_ITEM_CLASS =
  "relative inline-flex items-center gap-1.5 rounded-md border whitespace-nowrap px-2.5 py-1.5 text-[13px] font-medium transition-all duration-200"

export const ENTERPRISE_NAV_ITEM_ACTIVE_CLASS =
  "text-[var(--gvx-hero-text)] border-[var(--gvx-hero-border)] bg-[var(--gvx-hero-card)]"
